...
public class TestDepresionBeck : MonoBehaviour
{
    private Animator personajeAnimator;   //Animator del personaje
        ...
        {
            posElement++;
            if (posElement < Constantes.TOTAL_PREGUNTAS_DEPRESION_BECK)
            {
                transform.position = new Vector3(
                    Constantes.TESTDEPRESIONBECK_X[posElement], 
                    Constantes.TESTDEPRESIONBECK_Y[posElement],
                    Constantes.TESTDEPRESIONBECK_Z[posElement]);
        ...
        private void OnMouseDown()
        {
            if(!disponible)
            {
                xObjetivo = Constantes.TESTDEPRESIONBECK_X[posElement];
                yObjetivo = Constantes.TESTDEPRESIONBECK_Y[posElement];
                zObjetivo = Constantes.TESTDEPRESIONBECK_Z[posElement];
