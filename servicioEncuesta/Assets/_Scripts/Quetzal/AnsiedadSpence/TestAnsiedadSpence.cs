...
public class TestAnsiedadSpence : MonoBehaviour
{
        ...
        {
            posElement++;
            if (posElement < Constantes.TOTAL_PREGUNTAS_ANSIEDAD_SPENCE)
            {
                transform.position = new Vector3(
                    Constantes.TESTANSIEDADSPENCE_X[posElement], 
                    Constantes.TESTANSIEDADSPENCE_Y[posElement],
                    Constantes.TESTANSIEDADSPENCEK_Z[posElement]);
        ...
        private void OnMouseDown()
        {
            if(!disponible)
            {
                xObjetivo = Constantes.TESTANSIEDADSPENCE_X[posElement];
                yObjetivo = Constantes.TESTANSIEDADSPENCE_Y[posElement];
                zObjetivo = Constantes.TESTANSIEDADSPENCEK_Z[posElement];
